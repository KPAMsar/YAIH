    ...
    <header class="main-header fixed">
        ...
        <div class="header-lower">
        	<div class="auto-container clearfix">
                <!--Logo-->
                <div class="logo"><a href="index-2.html"><img src="{{asset('assets/frontend/images/logo.png')}}" alt="Volunteer" title="Volunteer"></a></div>
...
<script src="{{asset('assets/frontend/js/rev-plugins.js')}}"></script>
...
<script src="{{asset('assets/frontend/js/jquery-parallax.js')}}"></script>
...
<!-- Mirrored from world5.commonsupport.com/html/volunteer/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Aug 2022 00:26:18 GMT -->
</html>