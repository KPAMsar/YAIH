...
@section('content')
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 column project-column wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                	<article class="column-inner hvr-float-shadow">
                    	<figure class="image-box">
                        	<a href="#"><img src="{{asset('assets/frontend/images/resource/image-1.jpg')}}" alt="" title="Volunteer"></a>
        	...
        	<div class="row clearfix">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 column wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1000ms">
                	<article class="column-inner hvr-float">
                    	<figure class="image-box">
                        	<a href="#"><img src="{{asset('assets/frontend/images/resource/image-5.jpg')}}" alt="" title="Volunteer Program"></a>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 column wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                	<article class="column-inner hvr-float">
                    	<figure class="image-box">
                        	<a href="#"><img src="{{asset('assets/frontend/images/resource/image-6.jpg')}}" alt="" title="Volunteer Program"></a>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 column wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                	<article class="column-inner hvr-float">
                    	<figure class="image-box">
                        	<a href="#"><img src="{{asset('assets/frontend/images/resource/image-7.jpg')}}" alt="" title="Volunteer Program"></a>
    ...
    <section class="sponsors-section">
    	<div class="container">
        	<ul class="slider">
            	<li><a href="#"><img src="{{asset('assets/frontend/images/clients/logo-6.png')}}" alt="" title=""></a></li>
                <li><a href="#"><img src="{{asset('assets/frontend/images/clients/logo-7.png')}}" alt="" title=""></a></li>
                <li><a href="#"><img src="{{asset('assets/frontend/images/clients/logo-8.png')}}" alt="" title=""></a></li>
                <li><a href="#"><img src="{{asset('assets/frontend/images/clients/logo-9.png')}}" alt="" title=""></a></li>
                <li><a href="#"><img src="{{asset('assets/frontend/images/clients/logo-10.png')}}" alt="" title=""></a></li>
            </ul>
        </div>
    </section>
