                                                        ...
                                                        <div class="col-xl-10 col-lg-12 col-md-8 mt-md-0 mt-4">
                                                            <div class="form">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4" name="fullname" id="fullName" placeholder="Full Name" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <div class="d-sm-flex d-block">
                                                                            <div class="form-group mr-1">
                                                                                <select class="form-control" name="dob_day" id="exampleFormControlSelect1">
                                                                                  <option>Day</option>
                                                                                  <option>1</option>
                                                                                  <option>2</option>
                                                                                  <option>3</option>
                                                                            ...
                                                                            <div class="form-group mr-1">
                                                                                <select class="form-control"  name="dob_month"  id="month">
                                                                                    <option>Month</option>
                                                                            ...
                                                                            <div class="form-group mr-1">
                                                                                <select class="form-control"  name="dob_year"  id="year">
                                                                                  <option>Year</option>
                                                                                  <option>2018</option>
                                                                                  <option>2017</option>
                                                                                  <option>2016</option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4" id="profession" name="profession"  placeholder="Profession" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-11 mx-auto">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="aboutBio" name="bio" placeholder="Tell something interesting about yourself" rows="10">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control mb-4" name="address" id="address" placeholder="Address" value="New York" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="location">Email</label>
                                                                <input type="text" class="form-control mb-4" name="email" id="email" placeholder="Email Address">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="phone">Phone</label>
                                                                <input type="text" class="form-control mb-4" name="phone" id="phone" placeholder="Write your phone number here" value="+1 (530) 555-12121">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control mb-4" name="website" id="website1" placeholder="Write your website here">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
