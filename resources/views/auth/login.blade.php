...
<!-- Mirrored from designreset.com/cork/ltr/demo4/auth_login_boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Aug 2022 16:37:20 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <form class="text-left"  method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="text" class="form-control" placeholder="Email Address" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                </div>
