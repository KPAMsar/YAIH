...
<!-- Mirrored from designreset.com/cork/ltr/demo4/auth_register_boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Aug 2022 16:37:23 GMT -->
                        ...
                        <form class="text-left" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control" placeholder="Fullname">
                                </div>
